...
>(({ className, orientation = "horizontal", ...props }, ref) => (
  <TabsPrimitive.List
    ...
    className={cn(
      ...
      orientation === "vertical" && "w-full flex-col items-stretch space-y-1 p-2",
      className
    )}
    {...props}
  />
...
>(({ className, orientation = "horizontal", ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      orientation === "vertical" && "w-full justify-start px-4 py-2.5 text-left",
